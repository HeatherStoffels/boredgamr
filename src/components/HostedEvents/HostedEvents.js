        ...
        <ul>
          {this.props.hostedEvents.map((event) => (
            <li key={event.event_id}>
              ...
              <button value={event.event_id} onClick={this.handleClickDelete}>
                Delete Event
              </button>
              <Link to='/edit'><button value={event.event_id} onClick={this.handleClickEdit}>Change Event</button></Link>
            </li>
          ))}
        </ul>
      </div>
